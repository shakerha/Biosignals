...
folder = ""; %add folder which contains xls file with cached server data 
list = funcs.createFileList('xls',folder);

%download edf files listed in xls file
for i = 1:size(list)
    cellArray = readcell(list{i});
    downloadFolderContentToHardDrive(cellArray, folder)
end
