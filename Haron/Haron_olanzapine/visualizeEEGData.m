...
% calcPValueAndMoreWithSampling(dataNormal, dataClozapine, 'Clozapine', 20, 95, 85);
% calcPValueAndMoreWithSampling(dataNormal, dataRisperidone, 'Risperidone', 20, 95, 95);

%createCompleteDrugsList();
f = countUniqueWords();
% 
% dataRisperidone = readcell('Risperidone_normal_data_sampling_201002.xls');
% dataClozapine = readcell('Clozapine_normal_data_sampling_201002.xls'); 
% dataRisperidone2 = readcell('Risperidone_normal_data_sampling_201002_2.xls');
% dataClozapine2 = readcell('Clozapine_normal_data_sampling_201002_2.xls'); 
% 
% % visualizePValues(dataPValue, bAT, bAbsolut, sFigureName)
% visualizePValues(dataClozapine2, false, false, 'Clozapine vs Normal - Absolut');
% visualizePValues(dataRisperidone2, false, false, 'Risperidone vs Normal - Absolut');
% %diffOfMeans = calcDifferenceOfMeans(dataClozapine);
% 
% barhGraph(dataClozapine2, dataRisperidone2, 'P3', 'clozapine');
